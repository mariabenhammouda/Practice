...
// A function to request username
...
function showResult(win = false) {
  ...
  // Send the user's name and score to the backend for ranking
  // You'll need to implement this part on your server

  // Once you receive the user's rank from the backend, display it
  // along with their score
  var userRank = 1; // Replace with the actual user rank
  document.querySelector(".user_rank").innerHTML = "Rank: " + userRank;
  document.querySelector(".final_score").innerHTML = "Score: " + score;
...
// Add this function to prompt for username
function promptForUsername() {
  var username = window.prompt("Enter your username:");
  return username;
}
